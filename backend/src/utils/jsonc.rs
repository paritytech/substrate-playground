...
/// Copied from https://github.com/serde-rs/json/issues/168#issuecomment-761831843
/// Alternatives using regexp have been considered but rejected due to `regex` limitations.
///
