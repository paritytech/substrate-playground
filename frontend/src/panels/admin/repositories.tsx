...
export function Repositories({ client, user }: { client: Client, user: User }): JSX.Element {
    ...
    return (
        ...
        {(resources: Repository[]) => (
            <>
                <EnhancedTableToolbar client={client} user={user} selected={selected?.id} label="Repositories" onCreate={() => setShowCreationDialog(true)} resourceType={ResourceType.Repository} />
